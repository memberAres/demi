              ...
              <div class="panel panel-default">
                  ...
                  <div class="panel-heading">
                       <div style="display: flex;justify-content: center">
                          <div>
                            <select class="mdb-select md-form colorful-select dropdown-primary" id="report_num" style="height: 40px;border-radius: 5px;background-color: #ddd">
                              <option selected value="0">Select for number of report</option>
                              <option value="1">1 Hour Report</option>
                              <option value="2">1 Day Report</option>
                              <option value="3">1 Week Report</option>
                              <option value="4">1 Month Report</option>
                              <option value="5">1 Year Report</option>
                              <option value="6">All Report</option>
                            </select>
                          </div>
                          <div id="viewNum" style="margin-left: 50px;font-size: 30px;"></div>
                        </div>
                  </div>
                                    ...
                                    <tr id="tr<?php echo $record->id ?>">
                                      ...
                                      <td class="text-center">
                                        ...
                                        <?php 
                                          ...
                                          ?>
                                          <button id="approv" type="button" onclick="approval(0)" class="btn btn-info btn-circle"><i class="fa fa-check"></i>
                                              </button>
                                        <?php }?>
                                      </td>
                                    </tr>
