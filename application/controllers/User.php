...
class User extends BaseController
{
    ...
    public function index()
    {
        ...
        else
        {
            ...
            $data['userRecords'] = $this->user_model->Allreport();
    ...
    function usersReport()
    {
            ...
            $returns = $this->paginationCompress ( "usersReport/", $count, 5 );
            
            $data['topreports'] = $this->user_model->usersReport($searchText, $returns["page"], $returns["segment"]);
    ...
    function NewReport()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'CodeInsect : Add NewReport';

            $this->loadViews("newReport", $this->global, $data, NULL);
        }
    }
    /**
    ...
    function viewReport($name)
    {
        $sname = str_replace("%20"," ",$name);
            ...
            $data['reports'] = $this->user_model->getReportInfo($sname);
            $this->global['pageTitle'] = 'Demi';
            $this->loadViews("viewReport", $this->global, $data, NULL);
    }

    function viewallReport($name,$date)
    {
        $sname = str_replace("%20"," ",$name);
        $sdate = str_replace("%20"," ",$date);
        $data['reports'] = $this->user_model->getallReportInfo($sname,$sdate);
        $this->global['pageTitle'] = 'Demi';
        $this->loadViews("viewReport", $this->global, $data, NULL);
    }
